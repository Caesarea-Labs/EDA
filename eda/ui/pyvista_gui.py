...
from eda.ui.layout_plot import LayoutPlotBindings, MeshGroup, add_layout_elements_to_plot
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, layout: Layout, show_polygon_names: bool):
        super().__init__()
        ...
        bindings = add_layout_elements_to_plot(self.c_layout, show_text=show_polygon_names, plotter=self.plotter)
...
def plot_layout_with_qt_gui(layout: Layout, show_polygon_names: bool = False):
